...
mod tests {
    ...
    fn test_typing_auto_expire() {
        ...
        assert!(
            !is_fresh_expired,
            "Fresh typing indicator should not be expired"
        );
        ...
        assert!(
            !is_boundary_expired,
            "Exactly 10 second old typing should not be expired"
        );
        ...
        assert!(
            is_very_stale_expired,
            "15 second old typing should be expired"
        );
    }
