...
export function setup() {
  ...
  if (reg1.status !== grpc.StatusOK || reg2.status !== grpc.StatusOK) {
  ...
  return {
    ...
    user1: {
      userId: reg1.message.user_id,
      deviceId: reg1.message.device_id,
      token: reg1.message.access_token,
    },
    user2: {
      userId: reg2.message.user_id,
      deviceId: reg2.message.device_id,
      token: reg2.message.access_token,
    },
  };
}
